...
*/}}
{{- define "auth-proxy-conf.fullname" -}}
...
*/}}
{{- define "auth-proxy-conf.trustedips" -}}
         trustedIPs = [
...
*/}}
{{- define "auth-proxy-conf.forwardedHeadersTrustedIPs" -}}
         trustedIPs = [
...
*/}}
{{- define "auth-proxy-conf.whiteListSourceRange" -}}
...
*/}}
{{- define "auth-proxy-conf.acme.domains" -}}
...
*/}}
{{- define "auth-proxy-conf.acme.dnsResolvers" -}}
         resolvers = [
...
*/}}
{{- define "auth-proxy-conf.ssl.cipherSuites" -}}
          cipherSuites = [
...
*/}}
{{- define "auth-proxy-conf.rootCAs" -}}
         rootCAs = [
